...
export function SuperintendenteDashboard(data: { token: string }) {
  ...
  const schema = z
    .object({
      nomeCompleto: z.string().min(1, 'Nome completo é um campo obrigatório'),
      email: z
        .string({
          errorMap: () => {
      ...
      cep: isTecnico
        ? z.string().optional()
        : z.string().min(1, 'CEP é um campo obrigatório'),
      telefone: z.string().min(1, 'Telefone é um campo obrigatório'),
      numeroCasa: isTecnico
        ? z.string().optional()
        : z.string().min(1, 'Numero da casa é um campo obrigatório'),
    })
    ...
    <Container>
      ...
      <Content>
          ...
          {tecnicoPage ? (
            <>
              ...
              <Table>
                ...
                {todosTecnicos.map((index: TecnicoDTO) => {
                  return (
                    <TableContent key={index.id}>
                      <td>
                        <Text
        ...
        <TelaRegistroUsuario
          ...
          animate={{
            y: userRegister ? 0 : -50,
            opacity: userRegister ? 1 : 0,
          }}
          transition={{ duration: 0.5 }}
          style={{
            display: `${userRegister ? 'flex' : 'none'}`,
            pointerEvents: `${userRegister ? 'auto' : 'none'}`,
          }}
            ...
            <InputPair style={{ width: '90%' }}>
              <InputPlace style={{ width: '47%' }}>
                <Text
                  ...
                  fontWeight="300"
                />
                <InputText {...register('nomeCompleto', { required: true })} />
              </InputPlace>

import { Home, add, animal, animalBlue, arrowLeft, boi, comunic, done, hamb, logo2Branca, logoBranca, search, seta, user, waiting } from '@/assets'
import {
    Container,
    Menu,
    Content,
    ...
    <Container>
        ...
        >
            ...
            <motion.div initial={{x:'0vw'}} transition={{duration:0.7}} animate={{x:menu?'0vw':'-20vw', opacity:menu?1:0}} style={{display:menu?'flex':'none',width:'96%', flexDirection:'column', justifyContent:'center'}}>
                ...
                <div style={{height:'20vw',display:'flex', justifyContent:'space-between', flexDirection:'column', marginTop:'3vw'}}>
                    ...
                    <DropdownMenu
                        initial={{opacity:0}}
                        animate={{y: animalPage ? '-6vw' : '-10vw', opacity: animalPage ? 1 : 0}} 
                        transition={{duration:0.5}}
        ...
        <Content>
            ...
            >
                ...
                <Text fontFamily="pop" size={"1.5vw"} text="Todos os criadores registrados na ABCPD" color="black" fontWeight="600"/>
                ...
                <Table>
                    <TableHeader>
                        ...
                        <th>
                        <Text textAlign='center' fontFamily="rob" size={"1.3vw"} text="RG" color="black" fontWeight="400"/>

                        </th>
                        <th>
                        <Text textAlign='center'  fontFamily="rob" size={"1.3vw"} text="Ver Animais" color="black" fontWeight="400"/>
                    ...
                    <TableContent>
                        ...
                        <td>
                            <div style={{display:'flex', width:'100%', justifyContent:'center', alignItems:'center', height:'100%'}}>
                                <Button marginTopImage='0.3vw' radius='2vw' marginLeftImage='0vw' marginRightImage='0vw' src={search} colorButton='#0B7AB8' heightButton='3vw'  widthImage='65%' widthButton='3vw' textColor='white' onClick={()=>{setVerAnimaisCriador(true), setAnimalPage(false)}}/>
                            </div>                         
                        </td>
            ...
            <Text text='Formulário Para Registro de Novo Animal | ABCPD' fontFamily='pop' fontWeight='700' size='1.8vw' color='#032759' />
            ...
            <InputPair style={{width:'90%'}}>
                <InputPlace style={{width:'47%'}}>
                    <Text fontFamily="pop" size={"1.5vw"} text="Pelagem" color="black" fontWeight="300"/>
                    <InputText width='30vw' border="solid 0.2vw black"/>
                </InputPlace>
            ...
            <div style={{width:'91.2%', display:'flex', justifyContent:'end'}}>
                <div style={{display:'flex', marginTop:'1vw', justifyContent:'space-between', width:'39%', marginBottom:'10vw'}}>
                    <Button colorButton='#032759' heightButton='2vw'  textButton='← Voltar' widthButton='7vw' textColor='white'/>
                    <Button colorButton='green' heightButton='2vw'  textButton='Registrar Novo Animal' widthButton='18vw' textColor='white'/>
                </div>
            </div>

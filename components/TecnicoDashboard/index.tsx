    ...
    async function getCriadores() {
      try {
        const response = await axios.request({
          ...
          url: `http://localhost:3001/criador/get-criadores`,
          method: 'GET',
        })
    ...
    <Container>
      ...
      <Content>
                  ...
                  <td>
                    ...
                    >
                      <Button
                        ...
                        textColor="white"
                        onClick={() => {
                          setVerAnimaisCriador(true), setAnimalPage(false)
                        }}
                      />
                    </div>
                  </td>
        ...
        >
          ...
          <div
            style={{ width: '91.2%', display: 'flex', justifyContent: 'end' }}
          >
            <div
              style={{
                display: 'flex',

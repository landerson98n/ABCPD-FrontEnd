...
export function AnimaisRegistro(data: CriadoresABCPDDTO) {
  ...
  async function getInformacoesAnimal(animal: AnimalDTO) {
    ...
    onAnimalChange('maeSelecionado', (todosAnimais.find((index: AnimalDTO) => {
      return index.id == animal.mae;
    }) || {} as AnimalDTO) );
    onAnimalChange('paiSelecionado', (todosAnimais.find((index: AnimalDTO) => {
                    ...
                    >
                      <Button
                        ...
                        onClick={() => {
                          ...
                          onAnimalChange('animalSelecionado', index );
                          onAnimalChange('resgistro', true );

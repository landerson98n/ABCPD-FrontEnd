...
export function CadastrarAnimal (props: CadastrarAnimal) {
    ...
    const animalSchema = z.object({
        ...
        "dataAvalicacao": z.
            ...
            min(
                1,
                "Data de Avaliação é um campo obrigatório"
            ),
        "dataNascimentoAnimal": z.
            string().
            min(
                1,
                "Data de Nascimento do Animal é um campo obrigatório"
            ),
        "nomeAnimal": z.string().min(
            1,
            "Nome do Animal é um campo obrigatório"
        ),
        "pelagemAnimal": z.
            string().
            min(
                1,
                "Pelagem do Animal é um campo obrigatório"
            ),
    ...
    async function send (animalData: AnimalDTO) {
        ...
        const animalPai = animaisCriador.find((index: AnimalDTO) => index.id === animalData.pai);

        const animalMatriz = animaisCriador.find((index: AnimalDTO) => index.id === animalData.mae);
        ...
        animalMatriz?.registro ===
          "Produtos do Cruzamento Sob Controle de Genealogia"
                ...
                return alert("Para ser puro controlado o animal deve seguir um dos requisitos: -Ser filho de animal Puro Controlado, -Ser filho de matriz com registro Produtos do Cruzamento Sob Controle de Genealogia -Ser filho de matriz com registro Produtos do Cruzamento Sob Controle de Genealogia");
      ...
      "Produtos do Cruzamento Sob Controle de Genealogia"
        ...
        } else if (animalData.pai === "" && animalData.mae == "") {
      ...
      animalData.registro ===
        ...
        animalData.sexoAnimal === "Macho"
            ...
            return alert("O tipo de registro selecionado só é permitido para fêmeas (Puro de Origem por Adjudicação e Produtos do Cruzamento Sob Controle de Genealogia)");
        ...
        const base64Image01 = await convertToBase64(new Blob([images.selectedImage]));
        ...
        if (typeCadastro == "animalBase") {
            ...
            animalData.nomeAnimal = `${
                (
                    rebanhos.find((reb: RebanhoDTO) => reb.id == solicitacaoBase.rebanhoId) || {}
                ).serie.toUpperCase()
            }${animalData.nomeAnimal}`;
        ...
        <Container onSubmit={handleSubmit(send)}>
            ...
            <InputPair style={{"width": "90%"}}>
              ...
              Selecione uma opção
                        ...
                        <option disabled={Boolean(isCG)}>Puro de Origem por Adjudicação</option>
                        <option disabled={Boolean(isCG)}>Puro Controlado</option>
                        <option disabled={Boolean(isCG)}>Puro de Origem</option>
                        <option selected={Boolean(isCG)} disabled={!isCG}>
              Produtos do Cruzamento Sob Controle de Genealogia
                        </option>
                    </SelectBox>
                </InputPlace>
            ...
            <InputPair style={{"width": "90%",
                ...
                <InputPlace style={{"width": "47%"}}>
                    {fieldNames2.map((fieldName) => <div key={fieldName} style={{"width": "100%"}}>
                        <InputPlace style={{"width": "100%"}}>
                            <Text
                                fontFamily="pop"
                                size={"1.5vw"}
          ...
          "
            ...
            <InputPair style={{"width": "90%",
                ...
                <InputPlace style={{"width": "47%"}}>
                    {fieldNames4.map((fieldName) => <div key={fieldName} style={{"width": "100%"}}>
                        <InputPlace style={{"width": "100%"}}>
                            <Text
                                fontFamily="pop"
                                size={"1.5vw"}
          ...
          "
            ...
            <InputPair style={{"width": "90%",
                ...
                <InputPlace style={{"width": "47%"}}>
                    {fieldNames6.map((fieldName) => <div key={fieldName} style={{"width": "100%"}}>
                        <InputPlace style={{"width": "100%"}}>
                            <Text
                                fontFamily="pop"
                                size={"1.5vw"}
